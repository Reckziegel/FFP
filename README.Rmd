...
- `exp_smoothing()`: accounts for the time-changing nature of volatility by giving more weight to recent observations;
...
fp_es1 <- exp_smoothing(invariants, 0.0166)
fp_es2 <- exp_smoothing(invariants, 0.0055)
