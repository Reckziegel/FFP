...
<a href='https://reckziegel.github.io/FFP/'><img src='man/figures/ffp_sticker.png' align="right" height="139" /></a>
...
To overcome this difficulty, the Fully Flexible Probabilities (FFP) approach offers an inexpensive way for scenario generation: it reprices the _probabilities_ associated to each scenario, instead of the scenarios themselves. Once the new probabilities have been defined, the computations can be performed very quickly because the burden of scenario generation is left aside.
...
on the market for portfolio construction (mean-variance, risk-parity, etc.): 
